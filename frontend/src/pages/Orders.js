...
import orderMissing from "../images/ordermissing.png";
import {
  getOrderByUser,
  ...
  return (
    <>
      ...
      <Container class1="cart-wrapper home-wrapper-2 py-5">
        {userOrderState.length == 0 && userServiceOrderState.length == 0 && (
          <div>
            <h1 style={{ textAlign: "center" }}>You have placed no orders</h1>
            <img src={orderMissing} alt="" class="rounded mx-auto d-block" />
          </div>
        )}
        {userOrderState.length > 0 && (
          <div className="row">
        ...
        {userServiceOrderState.length > 0 && (
          <div className="row">
            <div className="col-12">
